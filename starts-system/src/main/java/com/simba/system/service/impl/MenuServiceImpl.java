...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    @Override
    public List<Menu> getMenusWithRoleByUrl(String url) {
        return menuMapper.getMenusWithRoleByUrl(url);
    }
